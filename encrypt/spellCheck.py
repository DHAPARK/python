...
f3 = open("EnglishWords.txt",'r',encoding='utf-8')
...
for i in range(len(ifc)):
    if(ifc[i] == "." or ifc[i] == '?' or ifc[i] == '!' or ifc[i] == "," or ifc[i] ==':' or ifc[i]==';' or ifc[i] == '-' or ifc[i] == '[' or ifc[i] == ']' or ifc[i] == '{' or ifc[i] == '}' or ifc[i] == "'" or ifc[i] == '"' or ifc[i] == '...' or ifc[i] == '@' or ifc[i] == '#'):
        Pcnt=Pcnt+1
        allstr2.append('')
        continue
